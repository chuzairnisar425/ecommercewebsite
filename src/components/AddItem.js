...
const AddItem = () => {
// inital products of the ecommerce website
...
// toggle functionality 
  ...
  const pricePerItem = 100; // Assuming a fixed price for demonstration
  ...
  return (
    ...
    <div className="mx-2 mt-3">
      ...
      <div className="row bg-black text-white py-5">
        <div className="col-12 d-flex justify-content-between border-bottom-item pb-2">
          <span>Product</span>
          <span>Quantity</span>
          <span>Total</span>
        </div>
        ...
        <Link to='/Shipping'>  <button className="btn btn-light my-3">Continue Shopping</button></Link>
          <p>
            Have an account?{' '}
